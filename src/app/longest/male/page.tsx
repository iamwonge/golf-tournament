...
export default function MaleLongestPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">남자부 가장 긴 거리를 기록한 참가자가 승리합니다!</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <div className="text-sm text-gray-600">남자 참가자</div>
        </div>
        <div className="bg-white dark:bg-white rounded-lg shadow-md p-6 text-center">
      ...
      <div className="bg-white dark:bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-6">남자부 거리 시각화</h2>
      ...
      {/* 순위표 */}
      <div className="bg-white dark:bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">남자부 순위표</h2>
